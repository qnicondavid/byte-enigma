...
public final class SeedSweep {
    ...
    public interface SeedEvaluator {
        ...
        Candidate evaluate(int seed, ByteEnigma machine, byte[] ciphertext, byte[] out);
    }
    ...
    public SweepResult sweep(long start, long end, byte[] ciphertext, SeedEvaluator evaluator) {
        ...
        ByteEnigma machine = new ByteEnigma((int) start, rotorCount);
        long tried = 0;
    ...
    private final class Worker implements Runnable {
        ...
        @Override
        public void run() {
            ByteEnigma machine = new ByteEnigma(0, rotorCount);
            while (true) {
